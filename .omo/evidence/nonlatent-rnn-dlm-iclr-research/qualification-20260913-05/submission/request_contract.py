...
GLOBAL_LAUNCHER_PATH: Final = (
    "/inspire/hdd/global_user/zhangjiaquan-253108540222/"
    "nonlatent_iclr_qualification/payloads/"
    "qualification-20260913-05-global-ffaa464d-bytecode-v5/scale/experiments/"
    "nonlatent_iclr/qualification/run_qualification.sh"
)
LAUNCH_COMMAND: Final = (
    "/usr/bin/bash /inspire/hdd/global_user/zhangjiaquan-253108540222/"
    "nonlatent_iclr_qualification/payloads/"
    "qualification-20260913-05-global-ffaa464d-bytecode-v5/scale/experiments/"
    "nonlatent_iclr/qualification/run_qualification.sh"
)
...
class CreateJobRequest(BaseModel):
    ...
    task_priority: Annotated[Literal[4], Field(ge=1, le=10)]
