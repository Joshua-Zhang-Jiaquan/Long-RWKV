...
The six completed evaluations and one stopped startup attempt use 6.60 additional H100-hours. The stopped attempt produced no predictions and was manually replaced using the same frozen evaluation. Its zero reported runtime and startup logs are both retained in the operations record.
