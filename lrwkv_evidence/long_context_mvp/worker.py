"""RWKV development qualification/training, separate from frozen confirmation."""
import argparse
import json
import os
...
from . import training as R,tasks as T
...
def main():
    ...
    contract=dict(recipe=R.RECIPE,base_sha256=W.file_sha(args.base/'model.safetensors'),
