...
The protocol is machine-readable at \texttt{DAN/nonlatent\_iclr/preregistration.json},
with its builder and checks in \texttt{scale/experiments/nonlatent\_iclr/preregistration.py}.
