...
ability. \emph{On one cell}: it is the only cell in this program that stored its
generated text, and the others are therefore \notrun{} rather than corroborating ---
a single cell with $n = 200$ is what the evidence supports, and the count is stated
rather than a percentage. The evaluation's prompt asks explicitly for the answer in
