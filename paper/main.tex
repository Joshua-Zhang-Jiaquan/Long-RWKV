...
$P(X \geq k) = 0.52$ and $0.56$. Both are inseparable. The completions are degenerate
...
and the tier never fired. Counting a substring is not counting what the code does.
